...
* c : total max connections, total number of API connections used by the application, default value: 4
* cpf : connections per file, download a file using only specified number of connections, default value: 2, `preferably, c (total max connections)  >= cpf (connections per file)`
